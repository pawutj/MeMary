...
label room09:
    ...
    if room09_is_pass == False: 
        ...
        cat normal  "ตามหลักก็ใช่จ้ะ"
        yume  "ดูตอบกำกวมนะ"
        "เจ้าแมวส้มเงียบลงสักพัก ไม่นานหลังจากนั้นมันก็มองสบตาเราตรงๆ"
        cat normal "ฉันหวังว่าเธอจะทนรับทุกอย่างได้เมื่อตัวตนของเธอกลับมา"
        yume  "....."
...
label after_room_9:
    ...
    yume "หา?"
    cat normal "เธออาจจะนึกว่าเธอไม่มีตัวตน แต่จริงๆแล้วเธอทำเป็นมองไม่เห็นมันหรือเปล่า?"
    yume "หมายความว่า..."
    cat normal "เธอไม่ได้หายไปไหนหรอก เธอยังอยู่ที่นี่ ตรงนี้"
    yume "....."
    cat normal "เพียงแต่เธอไม่อยากยอมรับว่าตัวเธอมีอยู่ เธอเลยทำเป็นมองข้ามความจริงทั้งหมดไป"
    yume "นั่นมัน..."
