label intro:
    ...
    cat "ดูเหมือนว่าเธอจะไม่รู้อะไรเลยสินะ"
    yume "ฉัน?"
    ...
    cat "เธออย่าฝืนจะดีกว่า"
    yume "ฝืน?"
    cat "ตอนนี้เธอไม่สามารถนึกได้หรอกว่าตัวเธอเป็นใคร"
    yume "....."

    cat "ถ้าเธออยากได้คำตอบว่าเธอเป็นใคร ทำไมเธอถึงอยู่ที่นี่ เธอมีทางเลือกเดียวเท่านั้น"
    yume "ทางเลือก?"
    cat "ตามฉันมา"
